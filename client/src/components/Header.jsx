  ...
  return (
    ...
    >
      ...
      viewport={{once:true}}>
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn your text to <span className='text-blue-400'
        initial={{opacity:0}} 
     ...
     className='flex flex-wrap justify-center mt-16 gap-3'>
      ...
      animate={{opacity:1}}
      className='mt-2 text-neutral-600'>Generated images from ImageHub</motion.p>     
